            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm font-semibold leading-6 text-slate-600">
                  Ang schedule at Emergency Stop ay maaari pa ring
                  mag-close ng bookings kahit manually open.
                </p>
              </div>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <div className="rounded-2xl bg-white p-4">
                ...
                <p className="mt-1 text-xl font-extrabold text-blue-950">
                  {formatTime(availability.current_time)}
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-white p-4">
                ...
                <p className="mt-1 font-extrabold text-blue-950">
                  {formatTime(opensAt)} – {formatTime(closesAt)}
                </p>
              </div>
            </div>
          </article>
